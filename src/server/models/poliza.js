...
const PolizaSchema = new Schema({
    ...
    nombreAseguradora:{ type: String, uppercase: true },
    ...
    rutMandante:{ type: String,  uppercase: true },
    nombreMandante:{ type: String, uppercase: true },
    ...
    formaPago:{ type: String, uppercase: true },
